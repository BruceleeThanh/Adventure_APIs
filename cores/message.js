...
exports.create = function (data, callback) { // data:{id_conversation, owner, content}
...
exports.getLatestMessageByConversation = function (id_conversation, callback) { // data : {id_conversation, page, per_page}
    var query = Message.find({
